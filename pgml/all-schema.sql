...
BEGIN
  ...
  CREATE INDEX idx_%I_CustomerID ON %I (CustomerID);
  ', output_table, output_table, schema_name, schema_name, schema_name, output_table, output_table);
...
CREATE OR REPLACE PROCEDURE uc10_train(
    source_table TEXT,
    out_table TEXT,
    adjust_params boolean DEFAULT False
)
AS $$
BEGIN
