...
CALL uc10_train('uc10_train_preprocessed', 'uc10_model');
...
call save_results('sf15'); -- use the the argument as naming of output table for results
...
COPY (SELECT * FROM sf15_timeit)
    TO '/home/ll/tpcx-ai-benchmark/madlib_benchmark_results/sf15_timeit.csv' WITH CSV HEADER;
